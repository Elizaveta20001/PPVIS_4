...
public class Parse {
    ...
    private Tree tree;
    private DefaultMutableTreeNode laterNode;
    ...
    void runCommand(LinkedList<Double> operands, String operator) {
        ...
        String expression;
        if (operator.equals("sin") || operator.equals("cos") || operator.equals("tan") || operator.equals("sinh") || operator.equals("cosh") || operator.equals("tanh")) {
